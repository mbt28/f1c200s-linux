...
| branch | kernel | state |
|---|---|---|
| `main` | 6.6.143 | **v0.1.1**: cedar + colour-correct cedrus, both hardware-validated |
| `cedrus-6.6-backport` | 6.6.143 | **this branch** — tracks main (kept in sync for existing checkouts) |
